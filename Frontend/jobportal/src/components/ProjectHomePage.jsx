...
export class ProjectHomePage extends Component
 {
  ...
  showSignup() {
    ...
    let confirmpassword=document.getElementById("confirpassword");
    fullname.value="";
    email.value="";
    role.value="";
  ...
  render() {
    return (
      <div id='base'>
        ...
        <div id='footer'>
          <label className='copyrightText'>Copyright &copy; Dr.Deepak.V - KL University.All rights reserved</label>
